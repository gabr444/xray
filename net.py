...
class Net(nn.Module):
    def __init__(self):
        super().__init__()
        # Set the first conv2d layer to a channel size of 1 (gray-scale) and the kernel size to 3 (3*3 is the amount of pixels it will process at a time)
